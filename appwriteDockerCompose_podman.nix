...
in
{
  config = lib.mkIf ( cfg.appwrite.enable /*&& cfg.enable*/) {

    # Auto-generated using compose2nix v0.3.2-pre.
    # doesn't work because podman doesn't seem to expose the network and the site out: https://github.com/aksiksi/compose2nix?tab=readme-ov-file#podman-port-forwarding-in-internal-networks
    # Runtime
    ...
    systemd.services."podman-appwrite" = {
      ...
      after = [
        "podman-network-appwrite.service"
        "podman-volume-learnwitht_appwrite-cache.service"
        "podman-volume-learnwitht_appwrite-certificates.service"
        "podman-volume-learnwitht_appwrite-config.service"
        "podman-volume-learnwitht_appwrite-functions.service"
        "podman-volume-learnwitht_appwrite-uploads.service"
      ];
      requires = [
        "podman-network-appwrite.service"
        "podman-volume-learnwitht_appwrite-cache.service"
      ...
      partOf = [
        "podman-compose-learnwitht-root.target"
      ];
      wantedBy = [
        "podman-compose-learnwitht-root.target"
      ];
    ...
    systemd.services."podman-appwrite-assistant" = {
      serviceConfig = {
        Restart = lib.mkOverride 90 "always";
      };
      after = [
    ...
    systemd.services."podman-appwrite-console" = {
      serviceConfig = {
        Restart = lib.mkOverride 90 "always";
      };
      after = [
    ...
    systemd.services."podman-appwrite-mariadb" = {
      serviceConfig = {
        Restart = lib.mkOverride 90 "always";
      };
      after = [
        "podman-network-appwrite.service"
        "podman-volume-learnwitht_appwrite-mariadb.service"
      ];
      requires = [
        "podman-network-appwrite.service"
        "podman-volume-learnwitht_appwrite-mariadb.service"
    ...
    systemd.services."podman-appwrite-realtime" = {
      serviceConfig = {
        Restart = lib.mkOverride 90 "always";
      };
      after = [
    ...
    systemd.services."podman-appwrite-redis" = {
      serviceConfig = {
        Restart = lib.mkOverride 90 "always";
      };
      after = [
        "podman-network-appwrite.service"
        "podman-volume-learnwitht_appwrite-redis.service"
      ];
      requires = [
        "podman-network-appwrite.service"
        "podman-volume-learnwitht_appwrite-redis.service"
    ...
    systemd.services."podman-appwrite-task-maintenance" = {
      serviceConfig = {
        Restart = lib.mkOverride 90 "always";
      };
      after = [
    ...
    systemd.services."podman-appwrite-task-scheduler-executions" = {
      serviceConfig = {
        Restart = lib.mkOverride 90 "always";
      };
      after = [
    ...
    systemd.services."podman-appwrite-task-scheduler-functions" = {
      serviceConfig = {
        Restart = lib.mkOverride 90 "always";
      };
      after = [
    ...
    systemd.services."podman-appwrite-task-scheduler-messages" = {
      serviceConfig = {
        Restart = lib.mkOverride 90 "always";
      };
      after = [
    ...
    systemd.services."podman-appwrite-traefik" = {
      serviceConfig = {
        Restart = lib.mkOverride 90 "always";
      };
      after = [
        "podman-network-appwrite.service"
        "podman-network-gateway.service"
        "podman-volume-learnwitht_appwrite-certificates.service"
        "podman-volume-learnwitht_appwrite-config.service"
      ];
      requires = [
    ...
    systemd.services."podman-appwrite-worker-audits" = {
      serviceConfig = {
        Restart = lib.mkOverride 90 "always";
      };
      after = [
    ...
    systemd.services."podman-appwrite-worker-builds" = {
      serviceConfig = {
        Restart = lib.mkOverride 90 "always";
      };
      after = [
        "podman-network-appwrite.service"
        "podman-volume-learnwitht_appwrite-builds.service"
        "podman-volume-learnwitht_appwrite-functions.service"
      ];
      requires = [
        "podman-network-appwrite.service"
    ...
    systemd.services."podman-appwrite-worker-certificates" = {
      serviceConfig = {
        Restart = lib.mkOverride 90 "always";
      };
      after = [
    ...
    systemd.services."podman-appwrite-worker-databases" = {
      serviceConfig = {
        Restart = lib.mkOverride 90 "always";
      };
      after = [
    ...
    systemd.services."podman-appwrite-worker-deletes" = {
      serviceConfig = {
        Restart = lib.mkOverride 90 "always";
      };
      after = [
    ...
    systemd.services."podman-appwrite-worker-functions" = {
      serviceConfig = {
        Restart = lib.mkOverride 90 "always";
      };
      after = [
    ...
    systemd.services."podman-appwrite-worker-mails" = {
      serviceConfig = {
        Restart = lib.mkOverride 90 "always";
      };
      after = [
    ...
    systemd.services."podman-appwrite-worker-messaging" = {
      serviceConfig = {
        Restart = lib.mkOverride 90 "always";
      };
      after = [
    ...
    systemd.services."podman-appwrite-worker-migrations" = {
      serviceConfig = {
        Restart = lib.mkOverride 90 "always";
      };
      after = [
    ...
    systemd.services."podman-appwrite-worker-usage" = {
      serviceConfig = {
        Restart = lib.mkOverride 90 "always";
      };
      after = [
    ...
    systemd.services."podman-appwrite-worker-usage-dump" = {
      serviceConfig = {
    ...
    systemd.services."podman-appwrite-worker-webhooks" = {
      serviceConfig = {
        Restart = lib.mkOverride 90 "always";
      };
      after = [
    ...
    systemd.services."podman-openruntimes-executor" = {
      serviceConfig = {
        Restart = lib.mkOverride 90 "always";
      };
      after = [
        "podman-network-appwrite.service"
        "podman-network-runtimes.service"
        "podman-volume-learnwitht_appwrite-builds.service"
        "podman-volume-learnwitht_appwrite-functions.service"
      ];
      requires = [
    ...
    # Networks
    systemd.services."podman-network-appwrite" = {
      path = [ pkgs.podman ];
      serviceConfig = {
        Type = "oneshot";
        RemainAfterExit = true;
        ExecStop = "podman network rm -f appwrite";
      };
      script = ''
        podman network inspect appwrite || podman network create appwrite
      '';
      partOf = [ "podman-compose-learnwitht-root.target" ];
      wantedBy = [ "podman-compose-learnwitht-root.target" ];
    };
    systemd.services."podman-network-gateway" = {
      path = [ pkgs.podman ];
      serviceConfig = {
        Type = "oneshot";
        RemainAfterExit = true;
        ExecStop = "podman network rm -f gateway";
      };
      script = ''
        podman network inspect gateway || podman network create gateway
      '';
      partOf = [ "podman-compose-learnwitht-root.target" ];
      wantedBy = [ "podman-compose-learnwitht-root.target" ];
    };
    systemd.services."podman-network-runtimes" = {
      path = [ pkgs.podman ];
      serviceConfig = {
        Type = "oneshot";
        RemainAfterExit = true;
        ExecStop = "podman network rm -f runtimes";
      };
      script = ''
        podman network inspect runtimes || podman network create runtimes
      '';
      partOf = [ "podman-compose-learnwitht-root.target" ];
      wantedBy = [ "podman-compose-learnwitht-root.target" ];
    };
    ...
    # Volumes
    systemd.services."podman-volume-learnwitht_appwrite-builds" = {
      path = [ pkgs.podman ];
      serviceConfig = {
        Type = "oneshot";
        RemainAfterExit = true;
      ...
      script = ''
        podman volume inspect learnwitht_appwrite-builds || podman volume create learnwitht_appwrite-builds
      '';
      partOf = [ "podman-compose-learnwitht-root.target" ];
      wantedBy = [ "podman-compose-learnwitht-root.target" ];
    };
    systemd.services."podman-volume-learnwitht_appwrite-cache" = {
      path = [ pkgs.podman ];
      serviceConfig = {
        Type = "oneshot";
        RemainAfterExit = true;
      ...
      script = ''
        podman volume inspect learnwitht_appwrite-cache || podman volume create learnwitht_appwrite-cache
      '';
      partOf = [ "podman-compose-learnwitht-root.target" ];
      wantedBy = [ "podman-compose-learnwitht-root.target" ];
    };
    systemd.services."podman-volume-learnwitht_appwrite-certificates" = {
      path = [ pkgs.podman ];
      serviceConfig = {
        Type = "oneshot";
        RemainAfterExit = true;
      ...
      script = ''
        podman volume inspect learnwitht_appwrite-certificates || podman volume create learnwitht_appwrite-certificates
      '';
      partOf = [ "podman-compose-learnwitht-root.target" ];
      wantedBy = [ "podman-compose-learnwitht-root.target" ];
    };
    systemd.services."podman-volume-learnwitht_appwrite-config" = {
      path = [ pkgs.podman ];
      serviceConfig = {
        Type = "oneshot";
        RemainAfterExit = true;
      ...
      script = ''
        podman volume inspect learnwitht_appwrite-config || podman volume create learnwitht_appwrite-config
      '';
      partOf = [ "podman-compose-learnwitht-root.target" ];
      wantedBy = [ "podman-compose-learnwitht-root.target" ];
    };
    systemd.services."podman-volume-learnwitht_appwrite-functions" = {
      path = [ pkgs.podman ];
      serviceConfig = {
        Type = "oneshot";
        RemainAfterExit = true;
      ...
      script = ''
        podman volume inspect learnwitht_appwrite-functions || podman volume create learnwitht_appwrite-functions
      '';
      partOf = [ "podman-compose-learnwitht-root.target" ];
      wantedBy = [ "podman-compose-learnwitht-root.target" ];
    };
    systemd.services."podman-volume-learnwitht_appwrite-mariadb" = {
      path = [ pkgs.podman ];
      serviceConfig = {
        Type = "oneshot";
        RemainAfterExit = true;
      ...
      script = ''
        podman volume inspect learnwitht_appwrite-mariadb || podman volume create learnwitht_appwrite-mariadb
      '';
      partOf = [ "podman-compose-learnwitht-root.target" ];
      wantedBy = [ "podman-compose-learnwitht-root.target" ];
    };
    systemd.services."podman-volume-learnwitht_appwrite-redis" = {
      path = [ pkgs.podman ];
      serviceConfig = {
        Type = "oneshot";
        RemainAfterExit = true;
      ...
      script = ''
        podman volume inspect learnwitht_appwrite-redis || podman volume create learnwitht_appwrite-redis
      '';
      partOf = [ "podman-compose-learnwitht-root.target" ];
      wantedBy = [ "podman-compose-learnwitht-root.target" ];
    };
    systemd.services."podman-volume-learnwitht_appwrite-uploads" = {
      path = [ pkgs.podman ];
      serviceConfig = {
        Type = "oneshot";
        RemainAfterExit = true;
      ...
      script = ''
        podman volume inspect learnwitht_appwrite-uploads || podman volume create learnwitht_appwrite-uploads
      '';
      partOf = [ "podman-compose-learnwitht-root.target" ];
      wantedBy = [ "podman-compose-learnwitht-root.target" ];
    };
    ...
    systemd.targets."podman-compose-learnwitht-root" = {
      unitConfig = {
