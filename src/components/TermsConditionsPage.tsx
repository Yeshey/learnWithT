    ...
    <section className="terms-page">
      <div className="container">
        ...
        <div className="terms-content">
          ...
          <h3>2. Services</h3>
          <p>The Teacher provides Portuguese language lessons (online and in-person), translation services, and related resources as described on the website. Service details, including duration, format, and pricing, are subject to change and will be confirmed upon booking or inquiry.</p>

          <h3>3. Bookings and Payment</h3>
          <p>Lessons must be booked in advance. Payment details and schedules will be provided upon confirmation. Accepted payment methods include Bank Transfer, PayPal, and Revolut. Full payment or agreed-upon installments are required before sessions commence unless otherwise agreed.</p>
          ...
          <p>All personal information and materials shared during lessons or translation services will be treated with the utmost confidentiality.</p>

          <h3>6. Intellectual Property</h3>
          <p>All teaching materials provided by the Teacher are protected by copyright and are for the client's personal educational use only. They may not be reproduced, distributed, or shared without explicit written permission.</p>
          ...
          <p><em>Last Updated: October 26, 2024</em></p>
        </div>
      </div>
    </section>
  );
